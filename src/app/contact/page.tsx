          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <div className="flex space-x-4">
                ...
                {/* Twitter */}
                <a href="https://x.com/BobXu350839133" target="_blank" rel="noopener noreferrer" className="bg-neutral-light p-3 rounded-full text-neutral-medium hover:text-primary transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
