          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <div className="flex space-x-4">
                {/* GitHub */}
                <a href="https://github.com/gds910228" target="_blank" rel="noopener noreferrer" className="bg-neutral-light p-3 rounded-full text-neutral-medium hover:text-primary transition-colors">
                ...
                {/* Twitter/X */}
                <a href="https://x.com/ArcherRealAI" target="_blank" rel="noopener noreferrer" className="bg-neutral-light p-3 rounded-full text-neutral-medium hover:text-primary transition-colors" aria-label="Twitter/X">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
